...
public class RetirmentAttachment {
...
//                System.out.println("22222222222222");  
    ...
    public void onClickAdd(ActionEvent actionEvent) {
        ViewObject ReimVo =
                   ADFUtils.findIterator("Retirement_VOIterator").getViewObject();
               ...
               String sourceDocument ="Retirement";
               ...
               ViewObject AttachmentVo =
                   ADFUtils.getApplicationModuleForDataControl("Oando_AMDataControl").findViewObject("Attachment_VO1");
