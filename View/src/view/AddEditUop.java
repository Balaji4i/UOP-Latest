      ...
      //  lineVO.clearCache();
        ...
        while (uopLine.hasNext()) {
         ...
         //   JSFUtils.setExpressionValue("#{bindings.AssetCategoryId.inputValue}", r.getAttribute("AssetCategoryId"));
            System.err.println("-------------category id------------------------->" +r.getAttribute("AssetCategoryId"));
           // r.setAttribute("AssetCategoryId"  , r.getAttribute("AssetCategoryId"));
...
//System.out.println("after setting the vakue ---- "+ r.getAttribute("CcTotAccuDepr"));
            ...
            System.out.println("fdcNbv----------------------" +fdcNbv);
            // CIP Cost
            BigDecimal cipCost =
            ...
            System.out.println("cipCost----------------------" +cipCost);
            ...
            System.out.println("After----------------------cipClosingBal " + cipClosingBal);
            //newlyadded
            BigDecimal CipOpeningBalance =
                (r.getAttribute("CipOpeningBalance") == null ? new BigDecimal(0) :
                 (BigDecimal) r.getAttribute("CipOpeningBalance"));

             System.out.println("After adding Cip cost " + cipClosingBal);
                System.out.println("After----------------------CipOpeningBalance " + CipOpeningBalance);
