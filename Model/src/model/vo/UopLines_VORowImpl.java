...
public class UopLines_VORowImpl extends ViewRowImpl {
    ...
    public static final int CIPOPENINGBALANCE = AttributesEnum.CipOpeningBalance.index();
...
//        return (BigDecimal) (ccAccuDeprOpening.add(ccPeriodDepr));
     ...
     */
    //newly added
    public BigDecimal getcipOpeningBalance() {
        return (BigDecimal) getAttributeInternal(CIPOPENINGBALANCE);
    }
    public void setcipOpeningBalance(BigDecimal value) {
        setAttributeInternal(CIPOPENINGBALANCE, value);
    }
    //
    ...
    /**
     * Gets the attribute value for CIP_OPENING_BALANCE using the alias name CipOpeningBalance.
     * @return the CIP_OPENING_BALANCE
     */
    public BigDecimal getCipOpeningBalance() {
        return (BigDecimal) getAttributeInternal(CIPOPENINGBALANCE);
    }
    ...
    /**
     * Sets <code>value</code> as attribute value for CIP_OPENING_BALANCE using the alias name CipOpeningBalance.
     * @param value value to set the CIP_OPENING_BALANCE
     */
    public void setCipOpeningBalance(BigDecimal value) {
        setAttributeInternal(CIPOPENINGBALANCE, value);
    }
